...
import com.connectedlab.templates.logging.ShortToStringStyle;
...
public class ErrorInfo implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder setUserMessageId(@StringRes int messageId, Object... formatArgs) {
            mError.mUserMessage = ApplicationModule.getInstance().getApplication().getString(messageId, formatArgs);
            return this;
        }
